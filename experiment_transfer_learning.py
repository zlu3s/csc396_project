...
#                   配置与超参数
# ============================================================
MODEL_DIR = "./roberta-base-sentiments"   # 本地模型路径
PERC_TRAIN = "datasets/perc_train.csv"             # 诗歌训练集
PERC_TEST  = "datasets/perc_test.csv"              # 诗歌测试集
SONGS_TRAIN = "datasets/500songs_train.csv"        # 歌词训练集
SONGS_TEST  = "datasets/500songs_test.csv"         # 歌词测试集

# 混合比例：0.0 表示不加歌词，1.0 表示加入全部歌词
...
def run_experiment():
    ...
    plt.plot(results["ratio"], results["f1_poems"], 'o-', label='Poems Test Set', linewidth=2)
    plt.plot(results["ratio"], results["f1_lyrics"], 's--', label='Lyrics Test Set', linewidth=2)

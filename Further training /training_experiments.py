...
TRAIN_CSV = "data/perc_train.csv"
TEST_CSV  = "data/perc_test.csv"
...
def evaluate_accuracy(model, loader):
    """Evaluates the model and computes the weighted F1 score."""
    model.eval()
...
def plot_history_combined(train_losses, val_f1s, method_name, save_dir):
    """Plots combined training loss and validation F1 score."""
...
def run_all_experiments():
    ...
    for method in METHODS:
        ...
        # --------------------------------------------------
            ...
            N = 2
            total_layers = 12
            # Target layers for training (last N layers)
            ...
            # Unfreeze the target transformer layers
